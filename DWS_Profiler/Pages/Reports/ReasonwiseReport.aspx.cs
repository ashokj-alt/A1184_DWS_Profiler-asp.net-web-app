...
{
    public partial class ReasonwiseReport : System.Web.UI.Page
    {
        ...
        public static string DataSearch(string Type, string Week, string Month, string StartDate, string EndDate, string Cell)
        {
            try
            {
                DataSet dtList = BusinessLayer.clsMain.ReasonwiseDataSearch(Type, Week, Month, StartDate, EndDate, Cell);
        ...
        public static string Export(string Type, string Week, string Month, string StartDate, string EndDate, string Cell)
        {
            try
            {
                DataSet dtList = BusinessLayer.clsMain.ExportReasonwiseData(Type, Week, Month, StartDate, EndDate, Cell);
                string json = Newtonsoft.Json.JsonConvert.SerializeObject(dtList);
                return json;
            }
            catch (Exception ex)
